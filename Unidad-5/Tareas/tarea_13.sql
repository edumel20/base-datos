...
--select * from persona WHERE strftime('%Y', fecha) = '1999';
...
select id, nombre from asignatura WHERE cuatrimestre = 1 and curso = 3 and id_grado = 7 ORDER BY id;
...
select asig.id, asig.nombre, g.id from asignatura asig JOIN grado g ON asig.id_grado = g.id WHERE g.nombre = 'Grado en Ingeniería Informática (Plan 2015)' ORDER BY asig.id;

/**
+----+--------------------------------------------------------------+----+
| id |                            nombre                            | id |
+----+--------------------------------------------------------------+----+
| 1  | Álgegra lineal y matemática discreta                         | 4  |
+----+--------------------------------------------------------------+----+
| 2  | Cálculo                                                      | 4  |
+----+--------------------------------------------------------------+----+
| 3  | Física para informática                                      | 4  |
+----+--------------------------------------------------------------+----+
| 4  | Introducción a la programación                               | 4  |
+----+--------------------------------------------------------------+----+
| 5  | Organización y gestión de empresas                           | 4  |
+----+--------------------------------------------------------------+----+
| 6  | Estadística                                                  | 4  |
+----+--------------------------------------------------------------+----+
| 7  | Estructura y tecnología de computadores                      | 4  |
+----+--------------------------------------------------------------+----+
| 8  | Fundamentos de electrónica                                   | 4  |
+----+--------------------------------------------------------------+----+
| 9  | Lógica y algorítmica                                         | 4  |
+----+--------------------------------------------------------------+----+
| 10 | Metodología de la programación                               | 4  |
+----+--------------------------------------------------------------+----+
| 11 | Arquitectura de Computadores                                 | 4  |
+----+--------------------------------------------------------------+----+
| 12 | Estructura de Datos y Algoritmos I                           | 4  |
+----+--------------------------------------------------------------+----+
| 13 | Ingeniería del Software                                      | 4  |
+----+--------------------------------------------------------------+----+
| 14 | Sistemas Inteligentes                                        | 4  |
+----+--------------------------------------------------------------+----+
| 15 | Sistemas Operativos                                          | 4  |
+----+--------------------------------------------------------------+----+
| 16 | Bases de Datos                                               | 4  |
+----+--------------------------------------------------------------+----+
| 17 | Estructura de Datos y Algoritmos II                          | 4  |
+----+--------------------------------------------------------------+----+
| 18 | Fundamentos de Redes de Computadores                         | 4  |
+----+--------------------------------------------------------------+----+
| 19 | Planificación y Gestión de Proyectos Informáticos            | 4  |
+----+--------------------------------------------------------------+----+
| 20 | Programación de Servicios Software                           | 4  |
+----+--------------------------------------------------------------+----+
| 21 | Desarrollo de interfaces de usuario                          | 4  |
+----+--------------------------------------------------------------+----+
| 22 | Ingeniería de Requisitos                                     | 4  |
+----+--------------------------------------------------------------+----+
| 23 | Integración de las Tecnologías de la Información en las Orga | 4  |
|    | nizaciones                                                   |    |
+----+--------------------------------------------------------------+----+
| 24 | Modelado y Diseño del Software 1                             | 4  |
+----+--------------------------------------------------------------+----+
| 25 | Multiprocesadores                                            | 4  |
+----+--------------------------------------------------------------+----+
| 26 | Seguridad y cumplimiento normativo                           | 4  |
+----+--------------------------------------------------------------+----+
| 27 | Sistema de Información para las Organizaciones               | 4  |
+----+--------------------------------------------------------------+----+
| 28 | Tecnologías web                                              | 4  |
+----+--------------------------------------------------------------+----+
| 29 | Teoría de códigos y criptografía                             | 4  |
+----+--------------------------------------------------------------+----+
| 30 | Administración de bases de datos                             | 4  |
+----+--------------------------------------------------------------+----+
| 31 | Herramientas y Métodos de Ingeniería del Software            | 4  |
+----+--------------------------------------------------------------+----+
| 32 | Informática industrial y robótica                            | 4  |
+----+--------------------------------------------------------------+----+
| 33 | Ingeniería de Sistemas de Información                        | 4  |
+----+--------------------------------------------------------------+----+
| 34 | Modelado y Diseño del Software 2                             | 4  |
+----+--------------------------------------------------------------+----+
| 35 | Negocio Electrónico                                          | 4  |
+----+--------------------------------------------------------------+----+
| 36 | Periféricos e interfaces                                     | 4  |
+----+--------------------------------------------------------------+----+
| 37 | Sistemas de tiempo real                                      | 4  |
+----+--------------------------------------------------------------+----+
| 38 | Tecnologías de acceso a red                                  | 4  |
+----+--------------------------------------------------------------+----+
| 39 | Tratamiento digital de imágenes                              | 4  |
+----+--------------------------------------------------------------+----+
| 40 | Administración de redes y sistemas operativos                | 4  |
+----+--------------------------------------------------------------+----+
| 41 | Almacenes de Datos                                           | 4  |
+----+--------------------------------------------------------------+----+
| 42 | Fiabilidad y Gestión de Riesgos                              | 4  |
+----+--------------------------------------------------------------+----+
| 43 | Líneas de Productos Software                                 | 4  |
+----+--------------------------------------------------------------+----+
| 44 | Procesos de Ingeniería del Software 1                        | 4  |
+----+--------------------------------------------------------------+----+
| 45 | Tecnologías multimedia                                       | 4  |
+----+--------------------------------------------------------------+----+
| 46 | Análisis y planificación de las TI                           | 4  |
+----+--------------------------------------------------------------+----+
| 47 | Desarrollo Rápido de Aplicaciones                            | 4  |
+----+--------------------------------------------------------------+----+
| 48 | Gestión de la Calidad y de la Innovación Tecnológica         | 4  |
+----+--------------------------------------------------------------+----+
| 49 | Inteligencia del Negocio                                     | 4  |
+----+--------------------------------------------------------------+----+
| 50 | Procesos de Ingeniería del Software 2                        | 4  |
+----+--------------------------------------------------------------+----+
| 51 | Seguridad Informática                                        | 4  |
+----+--------------------------------------------------------------+----+
**/
...
select COUNT(id) AS numero_alumnas from persona WHERE sexo = 'M' and tipo = 'alumno';
...
select COUNT(id) AS nacidos_1999 from persona WHERE fecha_nacimiento regexp '1999' and tipo = 'alumno';
